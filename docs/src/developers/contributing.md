...
[here](https://github.com/MineralsCloud/EasyJobs.jl/tree/master/docs).
...
[here](https://github.com/MineralsCloud/EasyJobs.jl/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
